...
add_image_size( 'large-crop', 463, 300, true);
add_image_size( 'portrait', 226, 300, true);
add_image_size( 'long', 463, 150, true);
...
function enqueue_scripts() {
    ...
    wp_enqueue_script('modernizr', get_stylesheet_directory_uri().'/js/vendor/modernizr-2.8.3.min.js', array(), null);
